                ...
                <section className="gridWrapper">
                    ...
                    <section id = "animation" className="gridContainer inline">
                        ...
                        <section className="projectHighlight rounded">
                            ...
                            <section>
                                <article className="inline projectLabel wordWrap projectPadding">Downloadable JY File:</article><article className="inline projectDescription projectPadding"><a className="projectLink" href = "/downloads/dig251-react-js/animation.jy" download>animation.jy</a></article>
                            </section>
                            <section>
                    ...
                    <section id = "tbs" className="gridContainer inline">
                        ...
                        <section className="projectHighlight rounded">
                            ...
                            <section>
                                <article className="inline projectLabel wordWrap projectPadding">Link to ZIP File:</article><article className="inline projectDescription projectPadding"><a className="projectLink" href = "/downloads/dig251-react-js/tbs.zip" download>tbs.zip</a></article>
                            </section>
                            <section>
                ...
                <section className="gridWrapper">
                    ...
                    <section id = "lms" className="gridContainer inline">
                        ...
                        <section className="projectHighlight rounded">
                            ...
                            <section>
                                <article className="inline projectLabel wordWrap projectPadding">Link to ZIP File:</article><article className="inline projectDescription projectPadding"><a className="projectLink" href = "/downloads/dig251-react-js/lms.zip" download>lms.zip</a></article>
                            </section>
                            <section>
