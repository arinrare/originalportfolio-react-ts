                ...
                <section className="gridWrapper">
                    ...
                    <section id = "everwarm" className="gridContainer inline">
                        ...
                        <section className="projectHighlight rounded">
                            ...
                            <section>
                                <article className="inline projectLabel wordWrap projectPadding">Link to Site:</article><article className="inline projectDescription projectPadding"><a className="projectLink" href = "/portfolio/everwarm-react-ts/" target="_blank">Everwarm Fuel Merchants</a></article>
                            </section>
                            <section>
